...
python main.py  --data_dir /share/huawei/data --log_dir /share/huawei/simsiam/logs/ -c /share/huawei/simsiam/configs/simsiam_aircrafts.yaml --ckpt_dir ~/.cache/ --hide_progress